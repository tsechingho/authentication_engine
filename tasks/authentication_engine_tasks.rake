namespace :authentication_engine do
  ...
  task :sync do
    ...
    system "rsync -ruv vendor/plugins/authentication_engine/config/authentication_engine.yml config"
    system "rsync -rbv vendor/plugins/authentication_engine/config/locales config"
    system "rsync -rbv vendor/plugins/authentication_engine/app/controllers/application_controller.rb app/controllers"
